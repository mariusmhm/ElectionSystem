        ...
        return (
            ...
            <div>
                ...
                <Container maxWidth="xl">
                                                    ...
                                                    <TableCell >
                                                        <TreeView
                                                            ...
                                                            <TreeItem nodeId="1" label={project.getName()}>
                                                                ...
                                                                <TreeItem nodeId="3" className={classes.grayHeader} label={"ProjectType " + project.getProjectType()} />
                    ...
                    <Typography className={classes.redHeader}> Second </Typography>
                    <Grid item container
                        direction="column"
                        xs={12}
                        md={12}
                    ...
                    <Typography className={classes.redHeader}> Third </Typography>
                    <Grid item container
                        direction="column"
                        xs={12}
                        md={12}
