...
class HomeScreenCompTwo extends Component {
   ...
   render() {
        ...
        return (
            ...
            <div>
                <Grid container>
                <Box padding={0} marginTop={5} marginBottom={5}>
                    <Typography variant="h4" align="center" color = "lightgray">MY PROJECTS</Typography>
                    </Box>
                    <Grid container>
                        {projects.length > 0  ? 
                            <>
                            {
                                projecttypes.map(pt =>
                                    <>
                                    <Grid item xs={12}><Typography variant="h5" color = "secondary">{pt.getName()}</Typography></Grid>
                                    {
                                        projects.map(p =>
                                            ...
                                            <TableEntry
                                                ...
                                                priority = {participations.find(ptpID => ptpID.project_id === p.getID()).priority}
                ...
                <Box padding={0} marginTop={5} marginBottom={5}>
                    <Typography variant="h4" align="center" color = "darkGray">PROJECT OVERVIEW</Typography>
                    </Box>
                <Grid container>
                    ...
                    {projects.length > 0  ? 
                        <>
                        {
                            projecttypes.map(pt =>
                                <>
                                <Typography variant="h5" color = "secondary" >{pt.getName()}</Typography>
                                {
                                    projects.map(p =>
                                        participations.filter(ptp => ptp.project_id === p.getID()).length > 0 ? 
                                            null
