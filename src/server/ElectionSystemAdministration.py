...
class ElectionSystemAdministration(object):
    ...
    def create_semester(self, winter_semester, grading_end_date, submit_projects_end_date, submit_projects_beginn_date,
                        grading_beginn_date):
    ...
    def create_project(self, project_id, project_name, short_description, link, room_desired, grade_average,
                       ...
                       blockdays_during_lecture, weekly, num_spots):
        # create participation
        project = Project()
